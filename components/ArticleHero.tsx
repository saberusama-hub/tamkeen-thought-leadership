...
/**
 * Render the title with the emphasis word in serif italic. No coloured
 * highlight; the italic carries the weight.
 */
    ...
    <header className="border-b border-green/20">
      <div className="mx-auto max-w-[1240px] px-8 pt-16 pb-14 max-[640px]:px-5 max-[640px]:pt-10 max-[640px]:pb-9">
        <div className="max-w-[820px] mx-auto">
          ...
          <p className="font-serif text-[22px] leading-[1.5] italic text-ink/85 max-w-[56ch] m-0 mb-10 max-[640px]:text-[18px]">
            {article.dek}
          </p>
