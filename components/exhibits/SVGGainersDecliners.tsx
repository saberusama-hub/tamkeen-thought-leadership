  ...
  return (
    ...
    >
      ...
      <g transform="translate(200,30)">
        <line x1={ZERO_X} y1={0} x2={ZERO_X} y2={490} stroke="#003D2B" strokeWidth={1.2} />
        <text x={ZERO_X} y={-14} textAnchor="middle" fontSize={12} fontWeight={600} fill="#003D2B">
          {axisLabel}
        </text>
        ...
        <text x={600} y={2} fontSize={10.5} fill="#003D2B" fontStyle="italic">
          ↑ Gainers
        </text>
